...
@push('meta_tags')
    ...
    <meta name="title" content="Sign In - {{ env('APP_NAME') }}">
    <meta name="description" content="I Write For Myself">
    <meta name="keywords" content="I Write For Myself, IWriteForMySelf, Sign In">
    ...
    <meta property="og:title" content="Sign In - {{ env('APP_NAME') }}">
    ...
    <meta name="twitter:title" content="Sign In - {{ env('APP_NAME') }}">
